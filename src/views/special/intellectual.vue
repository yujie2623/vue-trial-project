<template>
  <div class="main-content">
    <header-search :optionsArea="optionsArea" :isShowRouter="true" :isArea="true" @search="search" />
    <base-header title="知识产权侵权分析"></base-header>
  </div>
</template>
<script>
...
export default {
  components: { headerSearch, baseHeader },
  data() {
    return {
      optionsArea: [{
        value: '1',
